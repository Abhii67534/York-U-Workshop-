            ...
            <div className="max-w-7xl mx-auto px-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                <div className="bg-indigo-600 p-6 rounded-lg shadow-lg">
                  ...
                  <p>
                    Learn the basics of OpenCV and how to manipulate images in
                    real-time.
                  </p>
                </div>
                <div className="bg-purple-600 p-6 rounded-lg shadow-lg">
                  ...
                  <p>
                    Explore how to integrate computer vision into game
                    mechanics.
                  </p>
                </div>
                <div className="bg-pink-600 p-6 rounded-lg shadow-lg">
                  ...
                  <p>
                    Work on real-world projects, including face detection and
                    object tracking.
                  </p>
                </div>
              </div>
